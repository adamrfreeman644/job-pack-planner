(() => {
 ...
 routeBar.className='route-tools'; routeBar.innerHTML='<button type="button" class="secondary" id="plan-route">Plan day</button><button type="button" class="secondary" id="open-route">Start route</button><button type="button" id="undo-route" hidden></button>';
